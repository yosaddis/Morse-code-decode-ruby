# morse_code_decode_ruby<a name="readme-top"></a>
...
**morse_code** This project creates a methods will decode Morse code messages.
...
```bash
git clone https://github.com/yosaddis/Morse-code-decode-ruby.git
```
